<!DOCTYPE html>
        ...
        <head>
            ...
            <title>Santri | {{auth()->user()->level}} | Mutasi Masuk </title>
        </head>
                    ...
                    <!-- Add Project -->
                        <div class="row page-titles mx-0">
                            <div class="col-sm-6 p-md-0">
                                ...
                                <p class="mb-0">Data Mutasi Masuk</p>
                            </div>
                        </div>
                        <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0)">Table</a></li>
                                <li class="breadcrumb-item active"><a href="javascript:void(0)">Mutasi Masuk</a></li>
                            </ol>
                        </div>
                    </div>
                    <!-- row -->
    ...
    <input id="searchInput" type="text" class="form-control" placeholder="Cari ID Mutasi...">
                                        ...
                                        <a href="/add_mutasi-masuk" class="btn btn-success" title="Add">
    ...
    <tbody id="mutasiTable">
        ...
        <tr>
            ...
            <td class="text-center">
                <div class="btn-group">
                    <a href="{{ url('/mutasi-masuk/' . $m->id_mut_masuk . '/edit_mutasi-masuk') }}" class="btn btn-warning btn-sm mx-1" title="Edit">
                        <i class="fa fa-pencil"></i>
                    </a>
                </div>
                <form action="{{ route('mutasi-masuk.destroy', $m->id_mut_masuk) }}" method="POST" class="d-inline delete-form">
                    @csrf
                    @method('DELETE')
                    <button type="button" class="btn btn-danger btn-sm mx-1 delete-btn" data-id="{{ $m->id_mut_masuk }}" title="Hapus">
